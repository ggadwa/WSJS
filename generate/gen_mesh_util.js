...
genMeshUtility.buildMeshNormals=function(vertices,indexes,normalsIn)
{
...
genMeshUtility.buildMeshUVs=function(bitmapIdx,vertices,normals)
{
...
genMeshUtility.buildMeshTangents=function(vertices,uvs,indexes)
{
    var n,nTrig,nVertex,trigIdx;
