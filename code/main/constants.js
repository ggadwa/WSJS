...
export const LIMB_TYPE_JAW=3;
export const LIMB_TYPE_ARM=4;
export const LIMB_TYPE_HAND=5;
export const LIMB_TYPE_FINGER=6;
export const LIMB_TYPE_LEG=7;
export const LIMB_TYPE_FOOT=8;
export const LIMB_TYPE_TOE=9;
export const LIMB_TYPE_WHIP=10;
