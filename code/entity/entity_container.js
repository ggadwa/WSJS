...
export default class EntityContainerClass extends EntityClass
{
    ...
    run()
    {
        ...
        if (this.openOnActionKey) {
            if ((!this.core.input.isKeyDown('e')) && (!this.core.game.overlay.isTouchStickLeftClick())) return;
        }
        ...
        if ((actionKeyDown) && (!this.opened)) {
            ...
            if (this.openSound!==null) this.core.audio.soundStartGameFromList(this.core.game.map.soundList,this.position,this.openSound);
        ...
        if ((actionKeyDown) && (this.opened)) {
            ...
            if (this.closeSound!==null) this.core.audio.soundStartGameFromList(this.core.game.map.soundList,this.position,this.closeSound);
